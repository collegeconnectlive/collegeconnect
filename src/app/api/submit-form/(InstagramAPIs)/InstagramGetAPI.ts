export const fetchUserMedia = async () => {
  ...
  const ACCESS_TOKEN =
    "EAAMZAshxqcZAMBO0a2GKdnFb3LGtAaRq1NCZBy5orZBO6rEkSE3IO2vIWZAjVXTipilK2uf6HH2WgRxZAKhuY0Dac9gwiQSgTghrKGd62nERo5WjvuIjD8JDsSdssYZAHAogjoR1GSCfQEV88VzdvrAzpZAuJNE2FYJSOV8FE8tBZBdlX2OlBuL52SmIHVp8t2NdsLuqZBO9Qm"; // Replace with your Instagram Graph API access token
